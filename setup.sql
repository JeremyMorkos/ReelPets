...
INSERT INTO users (user_name, password_hash) VALUES ('SeemySnakes', '');
INSERT INTO users (user_name, password_hash) VALUES ('Frog delight', '');
INSERT INTO users (user_name, password_hash) VALUES ('CreepyCrawler', '');
...
INSERT INTO pets (name, type, image_url, favourite_food, hearts, user_id) VALUES ('Slimeball', 'Northern leopard frog', 'https://a-z-animals.com/media/2021/02/Leopard-Frog-on-rock-1024x535.jpg', 'Locusts', 500, 2);
INSERT INTO pets (name, type, image_url, favourite_food, hearts, user_id) VALUES ('Fred', 'Poison dart frog', 'https://a-z-animals.com/media/2021/07/Incredible-Rainforest-Animals_-Poison-Dart-Frogs.jpg', 'Grasshoppers', 600, 2);
INSERT INTO pets (name, type, image_url, favourite_food, hearts, user_id) VALUES ('Sally', 'Golden poison frog', 'https://a-z-animals.com/media/2018/09/Poison-Dart-Frog-yellow.jpg', 'Caterpillars', 800, 2);
INSERT INTO pets (name, type, image_url, favourite_food, hearts, user_id) VALUES ('Snape', 'Red-crowned toadlet', 'https://media.australian.museum/media/dd/images/Some_image.width-1200.75a457c.jpg', 'Blackworms', 900, 2);
INSERT INTO pets (name, type, image_url, favourite_food, hearts, user_id) VALUES ('Voldybaldy', 'Pacman frog', 'https://a-z-animals.com/media/2022/02/shutterstock_410912479.jpg', 'Mice', 2000, 2);
